...
const MISSIONS = [
  ...
  { id: "m11", title: "Street performance di almeno 10 min davanti a sconosciuti — raccogliere almeno una moneta (video stile spettatori casuali richiesto)", xp: 10 },
...
const BADGES = [
  ...
  { id: "veteran",   icon: "🍺", name: "Veteran",        desc: "10 Guinness",         type: "beer",    threshold: 10 },
  { id: "champion",  icon: "🏆", name: "Champion",       desc: "14 Guinness",         type: "beer",    threshold: 14 },
  { id: "legend",    icon: "👑", name: "Living Legend",  desc: "17 Guinness",         type: "beer",    threshold: 17 },
  { id: "god",       icon: "🔱", name: "Guinness God",   desc: "20 Guinness",         type: "beer",    threshold: 20 },
  { id: "hero",      icon: "🏆", name: "Mission Hero",   desc: "5 missioni",          type: "mission", threshold: 5 },
  { id: "spirit",    icon: "☘",  name: "Irish Spirit",   desc: "10 missioni",         type: "mission", threshold: 10 },
  { id: "allstar",   icon: "⭐", name: "All Star",       desc: "Tutte le missioni",   type: "mission", threshold: 15 }
];
